    ...
    <div id="app2">
        ...
        -->
                ...
                <ul class="kt-sticky-toolbar" style="margin-top: 30px;">
                    ...
                    <li class="kt-sticky-toolbar__item kt-sticky-toolbar__item--danger"
                        id="kt_sticky_toolbar_chat_toggler"
                        data-toggle="kt-tooltip" title="Chat Example" data-placement="left">
                        <a href="#" data-toggle="modal" data-target="#kt_chat_modal"><i
                                class="flaticon2-chat-1"></i></a>
                    </li>
                </ul>
                            ...
                            <div class="kt-chat">
                                <div class="kt-portlet kt-portlet--last">
                                    ...
                                    <div class="kt-portlet__body">
                                        <div class="kt-scroll kt-scroll--pull" data-height="410"
                                            ...
                                            <div class="kt-chat__messages kt-chat__messages--solid">
                                                ...
                                                <div class="kt-chat__message kt-chat__message--right kt-chat__message--brand">
                                                    ...
                                                    <div class="kt-chat__text">
                                                        You can unwatch this repository immediately <br>by clicking
                                                        here: <a
